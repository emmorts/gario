...
class GameObjectCanvasElement extends Element {
  constructor() {
    super();
  ...
  bind() {
    this._canvasElement = new DomElement('.js-gameobject-canvas');
  ...
  _setDefaultSize() {
    const defaultWidth = GameObjectCanvasElement._getDefaultWidth();
    const defaultHeight = GameObjectCanvasElement._getDefaultHeight();
...
module.exports = GameObjectCanvasElement;
